...
// import 'dart:io';
// import 'package:permission_handler/permission_handler.dart';
// import 'package:intl/intl.dart'; // Added import statement for DateFormat
//
// class CrHomePage extends StatefulWidget {
//   const CrHomePage({Key? key}) : super(key: key);
//
...
//         .where('date', isLessThan: selectedDate.add(Duration(days: 1)))
//         .where('time', isGreaterThanOrEqualTo: _formatTimeOfDay(startTime))
//         .where('time', isLessThanOrEqualTo: _formatTimeOfDay(endTime))
//         .get();
//
...
// //
// //     final fileName =
// //         '${selectedSubject}_${dateFormat.format(selectedDate)}_${timeFormat.format(startTime)}-${timeFormat.format(endTime)}.csv';
// //
// //     final directory = await getExternalStorageDirectory();
// //     final path = '${directory!.path}/PU Attendance/$fileName';
// //
...
// //         .collection('mscattendance')
// //         .where('subject', isEqualTo: selectedSubject)
// //         .where('date', isEqualTo: dateFormat.format(selectedDate))
// //         .where('time', isGreaterThanOrEqualTo: timeFormat.format(startTime))
// //         .where('time', isLessThanOrEqualTo: timeFormat.format(endTime))
// //         .get();
// //
// //     // Convert attendance data to CSV format
// //     List<List<dynamic>> csvData = [];
